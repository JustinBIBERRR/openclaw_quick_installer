...
![OpenClaw 一键安装器](openclaw_installer_windows/README_assets/logo.png)
...
![环境预检](openclaw_installer_windows/README_assets/env_check.png)
...
![安装 OpenClaw](openclaw_installer_windows/README_assets/openclaw_install.png)
![安装 OpenClaw 成功](openclaw_installer_windows/README_assets/openclaw_install_success.png)
...
![配置参数](openclaw_installer_windows/README_assets/config.png)
...
![Chat 页面](openclaw_installer_windows/README_assets/chat_page.png)

网关会自动启动，会出现新的powershell弹窗，保留该poewershell弹窗开启，即可确保网关gateway运行
![成功启动网关](openclaw_installer_windows/README_assets/gateway_success.png)
...
- 可点击下方new开启新的对话
![对话](openclaw_installer_windows/README_assets/page.png)
